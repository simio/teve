;;; Copyright (c) 2013, 2014 Jesper Raftegard <jesper@huggpunkt.org>
;;;
  ...
  (lambda sources
    (let* ((default-configuration
             '((operators (play? . #f)
               ...
               (channels (aktuellt . "http://www.svtplay.se/aktuellt")
                         (rapport . "http://www.svtplay.se/rapport")
                         (svt1 . "http://www.svtplay.se/kanaler/svt1")
                         (svt2 . "http://www.svtplay.se/kanaler/svt2")
                         (barnkanalen . "http://www.svtplay.se/kanaler/barnkanalen")
                         (svt24 . "http://www.svtplay.se/kanaler/svt24")
                         (kunskapskanalen . "http://www.svtplay.se/kanaler/kunskapskanalen"))))
...
(define *cfg*
  (let* ((sys-conf (if* (*platform* 'system-config-file) (read-ini it) '()))
    ...
    (make-configuration env-conf sys-conf user-conf)))
